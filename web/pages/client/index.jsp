        ...
        $(function () {
            ...
            $("button.addToCart").click(function () {
                ...
                $.getJSON("http://localhost:8080/book/cartServlet", "action=ajaxAddItem&id=" + bookId, function (data) {
                    ...
                    $("#cartLastName").html("您刚刚将 <span style='color: red'>" + data.lastName + "</span> 加入购物车中");
                });
            });
...
<%--                    您刚刚将<span id="cartLastName" style="color: red">${sessionScope.lastName}</span>加入到了购物车中--%>
                    <span id="cartLastName">您刚刚将 <span style='color: red'>${sessionScope.lastName}</span> 加入购物车中</span>
                </div>
            </c:if>
        </div>
